  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        {showAddFriend && <FormAddFriend addFriends={handleAddFriends} />}
...
function FriendsList({ friends, onSeletion, selectedFriend }) {
  return (
    <ul>
      {friends.map((friend) => (
        <Friend
...
function FormSplitBill({ selectedFriend, onUpdateBalance }) {
  ...
  function handleSpiltBill(e) {
    e.preventDefault();
    if (!bill || !paidByUser) return;
    onUpdateBalance(whoIsPaying === "user" ? paidByFriend : -paidByUser);
  }
  return (
    <form className="form-split-bill" onSubmit={handleSpiltBill}>
